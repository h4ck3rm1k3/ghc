...
## mikes hacks
MikesOpts=-dppr-debug -O -ddump-to-file -fno-max-relevant-binds  -keep-tmp-files  -ddump-parsed -ddump-parsed-ast
#-ddump-types -dppr-debug  -ddump-deriv
GhcLibHcOpts += $(MikesOpts)
GhcRtsHcOpts += $(MikesOpts)
SRC_HC_OPTS += $(MikesOpts)
